...
class ProductosActivity : AppCompatActivity() {
    ...
    fun agregaProductos(){
        coldDrinks.add(Product(name = "Caramel Frap", image = R.drawable.caramelfrap, description = "Caramel syrup meets coffee, milk and ice and whipped cream and buttery caramel sauce layer the love on top.", price = 5.00))
        coldDrinks.add(Product(name = "Chocolate Frap", image = R.drawable.chocolatefrap, description = "Rich mocha-flavored sauce meets up with chocolaty chips, milk and ice for a blender bash.", price = 6.00))
        ...
        coldDrinks.add(Product(“Oreo Milkshake”, R.drawable.oreomilkshake, “”, 7))
